...
const ParametresContent = () => {
  ...
  return (
    <div dir={isRtl ? 'rtl' : 'ltr'} style={{ padding: '24px 32px', maxWidth: '1200px', margin: '0 auto', fontFamily: isRtl ? "'Noto Sans Arabic', 'Segoe UI', sans-serif" : "'Inter', sans-serif" }}>
      ...
      {/* Messages */}
      {successMsg && <div style={{ padding:'12px 16px', backgroundColor:'#ecfdf5', border:'1px solid #10b981', color:'#047857', borderRadius:'10px', fontSize:'13px', fontWeight:'600', marginBottom:'20px', maxWidth:'700px' }}>{successMsg}</div>}
      {errorMsg && <div style={{ padding:'12px 16px', backgroundColor:'#fef2f2', border:'1px solid #ef4444', color:'#b91c1c', borderRadius:'10px', fontSize:'13px', fontWeight:'600', marginBottom:'20px', maxWidth:'700px' }}>{errorMsg}</div>}
      ...
      {activeSubTab === 'security' && (
        <div style={{ backgroundColor:'white', borderRadius:'12px', border:'1px solid #cbd5e1', padding:'28px 32px', maxWidth:'700px', boxShadow:'0 1px 3px rgba(0,0,0,0.02)' }}>
      ...
      {activeSubTab === 'system' && (
        <div style={{ backgroundColor:'white', borderRadius:'12px', border:'1px solid #cbd5e1', padding:'28px 32px', maxWidth:'700px', boxShadow:'0 1px 3px rgba(0,0,0,0.02)' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'20px' }}>
            ...
            <div>
              <label style={labelStyle}>{t.itemsPerPage}</label>
              <select name="itemsPerPage" value={sysConfig.itemsPerPage} onChange={handleSysChange} style={{ width:'100%', padding:'10px 12px', borderRadius:'8px', border:'1px solid #cbd5e1', outline:'none', fontSize:'13px', color:'#334155', backgroundColor:'white' }}>
